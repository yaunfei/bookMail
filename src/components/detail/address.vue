<template>
    <view class="co-address">
        <view>{{data.departure}}送至</view>
        <view>{{data.dest}}</view>
        <view>快递费{{data.expressFree}}元</view>
        <view></view>
    </view>
</template>
