    ...
    <view class="co-recom">
        <view class="recom-item"
            ...
            <view style="text-align:center">
                <image class="recom-img" :src="item.imgUrl" />
            </view>
...
const recom = [
    {
        imgUrl: "https://www.kfzimg.com/sw/kfz-cos/kfzimg/1862627/777d8277ce729ddf_n.jpg",
        title: "大唐西域记 1函5册",
        phase: "全新",
        address: "北京",
        price: "200",
    ...
    {
        imgUrl: "https://www.kfzimg.com/sw/kfz-cos/kfzimg/abadbcfb/704ca01a6cd94977_n.jpg ",
        title: "大唐西域记 1函5册",
        phase: "全新",
        address: "北京",
        price: "200",
...
.co-recom {
    ...
    background: linear-gradient(#fff,#f8f8f8 5.42rem,#f8f8f8); // 背景颜色渐变
    .recom-item {
        width: 45%;
        margin: 10px;
        overflow: hidden;
        ...
        .recom-img,.recom-title,.recom-price {
            padding: 10px 20px;
        }
    }
}
