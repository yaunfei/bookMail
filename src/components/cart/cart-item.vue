<template>
  <view class="co-cart-item">
    <view class="cart-item">
      <view class="item-icon check-icon"></view>
      <image
        class="item-img"
...
.co-cart-item {
  ...
  .check-icon {
    width: 50px;
    height: 50px;
    background: url(data:image/png;base64,)
      no-repeat;
    background-size: 100%;
  }
  .uncheck-icon {
